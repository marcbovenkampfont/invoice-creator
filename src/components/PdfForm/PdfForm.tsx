...
const PdfForm: React.FC = () => {
	...
	useEffect(() => {
		...
		const businessInfoData = getBusinessInfo();
...
if (!selectedBankAccount) {
		...
		if (!businessInfo) {
			alert("Por favor, añada la información de la empresa en la sección de ajustes");
			return;
		}
	...
	return (
		<div className="pdf-form">
			...
			<Modal 
				...
				title="Nuevo Cliente"
			>
				<NewClient onSuccess={handleClientCreated} />
			</Modal>
		</div>
	);
};
